...
const testimonials = [
  { name: 'Marcus Reid', role: 'Owner, Ironclad FC', avatar: 'MR', rating: 5, text: 'Vance replaced 4 different tools we were using. Fighter management, billing, scheduling — all in one place. We saved $400/month and our coaches actually enjoy using it.' },
  { name: 'Priya Sharma', role: 'Head Coach, Crescent BJJ', avatar: 'PS', rating: 5, text: 'Submitting classes for approval keeps our schedule clean — no more double-booked mats. Fighters love the QR check-in and we have zero no-shows now.' },
  ...
  { name: 'Sofia Martinez', role: 'Owner, Redline MMA', avatar: 'SM', rating: 5, text: 'Setup took literally 20 minutes. Imported all my fighters from a CSV, set up our session-based plans, and we were live. The support team is incredible too.' },
