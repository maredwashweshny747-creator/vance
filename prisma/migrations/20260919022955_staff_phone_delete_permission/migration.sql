...
-- CreateIndex
CREATE INDEX "Member_fighterId_idx" ON "Member"("fighterId");

-- CreateIndex
CREATE INDEX "Member_parentPhone_idx" ON "Member"("parentPhone");
...
-- CreateIndex
CREATE INDEX "CoachAttendance_classId_date_idx" ON "CoachAttendance"("classId", "date");

-- CreateIndex
CREATE INDEX "CoachAttendance_assignedCoachId_idx" ON "CoachAttendance"("assignedCoachId");

-- CreateIndex
CREATE INDEX "CoachAttendance_coachId_status_date_idx" ON "CoachAttendance"("coachId", "status", "date");
